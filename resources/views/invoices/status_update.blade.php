...
@section('content')
				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12">
						<div class="card">
							<div class="card-body">
								<form action="{{ route('status_update' , ['id' => $invoice->id]) }}" 
									method="post"
									autocomplete="off">
									@csrf
									{{-- 1 --}}
									...
									<div class="row">
										...
										<div class="col">
											...
											name="invoice_date" placeholder="YYYY-MM-DD"
									...
									<div class="row">
										...
										<div class="col">
											...
											<input readonly type="text" class="form-control" id="inputName" 
									...
									<div class="row">
										...
										<div class="col">
											...
											onchange="myFunction()" readonly value="{{ $invoice->rate_vat }}">
												<!--placeholder-->
												<option value="{{ $invoice->rate_vat }}" selected disabled>
													{{ $invoice->rate_vat }}
												</option>
